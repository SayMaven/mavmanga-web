...
export default function TagFilter({ 
  ...
  // Logika Klik Tag (Tri-state: Netral -> Include -> Exclude -> Netral)
  ...
  return (
    <div className="relative" ref={dropdownRef}>
       ...
       {isOpen && (
         <div className="absolute z-50 top-full left-0 mt-2 w-[90vw] md:w-[600px] lg:w-[800px] -translate-x-1/4 md:translate-x-0 bg-[#191A1C] border border-[#3b3e44] rounded-lg shadow-2xl p-4 flex flex-col max-h-[80vh] overflow-hidden">
                        ...
                        <div key={group.name}>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {group.tags.map((tag) => {
                                    ...
                                    let btnClass = "bg-[#232529] text-gray-300 hover:bg-[#3b3e44]"; // Neutral
                                    if (isInc) btnClass = "bg-blue-600/80 text-white border-blue-500 shadow-[0_0_8px_rgba(37,99,235,0.4)]"; // Include
                                    if (isExc) btnClass = "bg-red-600/80 text-white border-red-500 shadow-[0_0_8px_rgba(220,38,38,0.4)]"; // Exclude
