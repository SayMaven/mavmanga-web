...
interface ReaderSidebarProps {
    ...
    onOpenSettings: () => void; // Fungsi buka modal
...
export default function ReaderSidebar({
    ...
    // Helper untuk update image sizing (shortcut button di sidebar)
    const toggleFit = () => {
        // Toggle antara Contain Height dan Contain Width
        setConfig({
            ...config,
            imageSizing: {
                ...config.imageSizing,
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-4 space-y-3 custom-scrollbar">
                    ...
                    <div className="space-y-1">
                        <button className="w-full h-10 bg-[#3c3e44] hover:bg-[#4a4d55] rounded flex items-center px-3 text-sm text-gray-200 transition gap-3">
