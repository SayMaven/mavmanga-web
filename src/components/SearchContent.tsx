            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-4">
              ...
              <div>
                ...
                <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className={inputClass}>
                  ...
                  <option value="follows_high">Most Follows</option>
                  <option value="follows_low">Fewest Follows</option>
                  <option value="created_new">Recently Added</option>
              ...
              {/* 4. Demographic */}
              <div>
                <label className={labelClass}>Demographic</label>
                <select value={demo} onChange={(e) => setDemo(e.target.value)} className={inputClass}>
